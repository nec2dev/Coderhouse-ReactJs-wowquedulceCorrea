      ...
      <footer className="text-center bg-primary text-white">
        <div className="container px-6 pt-6">
          ...
          <div className="inline-flex items-baseline gap-12">
            <p><Link to="#!" className="fa fa-phone-square-alt"> </Link> +54 11 2 642 0901 </p>
            <p><Link to="#!" className="fa fa-paper-plane"> </Link> wowquedulce@gmail.com </p>
            <p><Link to="#!" className="fa fa-map-marked-alt"> </Link> Buenos Aires, 1440 Mataderos, CABA. </p>
          </div>
          </div>
          <div className="grid lg:grid-cols-4 md:grid-cols-2">
            <div className="mb-6">
              ...
              <ul className="list-none mb-0">
                ...
                <li><Link to="./tienda" className="text-white">Tienda</Link></li>
                <li><Link to="./nosotros" className="text-white">Nosotros</Link></li>
                <li><Link to="./contactos" className="text-white">Contactos</Link></li>
              </ul>
            </div>
            <div className="mb-6">
              <h5 className="font-bold mb-2.5">Legales</h5>
              <ul className="list-none mb-0">
                <li><Link to="#!" className="text-white">Privacy Policy</Link></li>
                <li><Link to="#!" className="text-white">Licensing</Link></li>
                <li><Link to="#!" className="text-white">Terms & Conditions</Link></li>
              </ul>
            </div>
            <div className="mb-6">
              <h5 className="font-bold mb-2.5">Seguinos</h5>
              <ul className="list-none mb-0">
                <li><i className="fab fa-behance mx-4"></i><i className="fab fa-instagram mx-4"></i></li>
                <li><i className="fab fa-twitter mx-4"></i><i className="fab fa-facebook-f mx-4"></i></li>
            ...
            <div className="mb-6 text-left text-sm">
              ...
              <ul className="list-none">
                <li><Link to="https://www.apple.com/app-store/"><img src={Appstore} alt="appstore logo"/></Link></li>
                <li><Link to="https://play.google.com/store"><img src={Googleplay} alt="google play logo"/></Link></li>             
              </ul>
            </div>
          </div>
        </div>
        <div className="inline-flex items-baseline">© 2022 Copyright: Todos los derechos reservados. Sitio desarrollado por <a className="text-white" href="https://nec2solutions.com/"><img src={Logonec} alt="logo nec2 solutions" className="w-20"/></a></div>
