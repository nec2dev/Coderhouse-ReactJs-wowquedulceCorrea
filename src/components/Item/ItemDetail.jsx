...
function ItemDetail({ product }) {
  ...
  const onAddWish = (quantity) => {
    setGoToWish(true);
    addToWish({ ...product, quantity: quantity });
  };
  return (
    <>
      <div
        key={product.id}
        className="container grid grid-cols-2 gap-6 bg-gray-100"
      >
        <div>
          <img
            src={product.imagen}
        ...
        <div>
          ...
          <p className="mt-4 text-gray-600">
            ...
            asperiores non facilis repudiandae fuga pariatur obcaecati nihil
            aspernatur sapiente, soluta adipisci. Explicabo, corporis deserunt
            distinctio nobis fuga architecto blanditiis!
          </p>
          <div className="pt-4">
          ...
          <div className="mt-4">
            ...
            {!goToCart ? (
              ...
              <div className="d-flex justify-content-center">
                ...
                <Link to={`/`}>
                  <button className="btn btn-danger bg-gradient ms-3 mt-3">
                    Seguir comprando
                  </button>
                </Link>
              </div>
          ...
          <div className="flex gap-2 pb-1">
            <div className="flex bg-primary rounded border border-gray-300 text-white w-20">
              <ItemCountWish
                initialWish={1}
                stockWish={product.stock}
                onAddWish={onAddWish}
              />
            </div>
            <Link
              to="/carrito"
              className="bg-primary border border-primary text-white px-8 py-2 font-medium rounded uppercase flex items-center gap-2 hover:bg-white hover:text-primary transition"
            >
          ...
          <div className="flex gap-3 pb-1">
            <Link
              to="/tienda"
              className="bg-terciary border border-terciary text-white px-8 py-2 font-medium rounded uppercase flex items-center gap-2 hover:bg-transparent hover:text-gray-600 transition"
            >
          ...
          <div className="w-3/5 pt-6">
            <div className="text-gray-600 space-y-3">
              <p>
                ...
                eveniet ducimus iure? Placeat, qui! Vitae eaque quaerat commodi
                quidem vero numquam animi perspiciatis ut? Aut quis eveniet
                exercitationem sit aliquid.
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione
                eveniet ducimus iure? Placeat, qui! Vitae eaque quaerat commodi
