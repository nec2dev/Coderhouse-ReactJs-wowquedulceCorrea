                    ...
                    <div className="flex rounded-lg">
                        <div className="w-full bg-white px-6 py-10 m-3 rounded-lg">
                            <div className="flex justify-between border-b pb-8">
                                ...
                                <h2 className="text-lg font-medium capitalize mb-4">{cartCounter()} Items</h2>
                            </div>
                                ...
                                <div className="flex items-center hover:bg-gray-100 my-4 px-2 py-2 border border-gray-200 rounded-lg">
                                    <div className="flex w-2/5">
                                        ...
                                        <div className="flex flex-col justify-between flex-grow">
                                            ...
                                            <div><button onClick={() => removeItem(prod.id)} className="font-semibold hover:text-red-500 text-gray-500 text-md">Eliminar</button></div>
                                        </div>
                                    </div>
